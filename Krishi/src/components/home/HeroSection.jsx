  ...
  const features = [
    {
      ...
      accent: '#4ade80',
      tag: 'Orbital Intel',
      title: 'Precision Crop Telemetry',
      subtitle: 'Deep orbital satellites monitor leaf spectra in real time, delivering sub-millimeter accuracy on plant health, chlorophyll density, and projected crop yield.',
      stat: '99.7%',
      statLabel: 'Accuracy',
      flip: false,
    },
    {
      ...
      title: 'Autonomous Field Ploughing',
      subtitle: 'AI-guided tractor fleets autonomously cultivate and plough fields with millimeter GPS precision — optimizing soil aeration across every acre.',
      stat: '3.8×',
    ...
    },
    {
      ...
      accent: '#60a5fa',
      tag: 'Zero-Waste Drip',
      title: 'Smart Moisture Telemetry',
      subtitle: 'Automated irrigation valves measure real-time moisture density and temperature, delivering exact water-cell nourishment precisely when roots request it.',
      stat: '4.2×',
      statLabel: 'Water Efficiency',
      flip: false,
    },
  ]
